...
static const _PerformanceMetrics_type_support_symbol_names_t _PerformanceMetrics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control, msg, PerformanceMetrics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control, msg, PerformanceMetrics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, control, msg, PerformanceMetrics)() {
  return &::control::msg::rosidl_typesupport_c::PerformanceMetrics_message_type_support_handle;
}
